...
//         // // Filter GSTINs for the selected domain from the fetched data
//         // const gstinDataForDomain = fetchedData.filter(item => item.domain === event.target.value)
//         //                                     .map(item => item.gstin);

//         // // Log the filtered GSTIN data in the console
//         // console.log('GSTIN data for domain', event.target.value, ':', gstinDataForDomain);
//     };
