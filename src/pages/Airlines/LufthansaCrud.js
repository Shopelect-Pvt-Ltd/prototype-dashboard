...
const LufthansaCrud = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get('http://127.0.0.1:5000/api/lufthansacreds');
    ...
    const handleDelete = async (rowData) => {
        ...
        try {
            await axios.delete('http://127.0.0.1:5000/api/lufthansacreds', { data: rowData });
    ...
    const handleSave = async () => {
        ...
        try {
            if (isEdit) {
                await axios.put('http://127.0.0.1:5000/api/lufthansacreds', popupData);
                setIsEdit(false)
            }
            else {
                await axios.post('http://127.0.0.1:5000/api/lufthansacreds', popupData);
            }
    ...
    return (
        <div className="dashboard-container" style={{ position: 'relative' }}>
            <h1>Lufthansa CREDENTIAL TABLE</h1>
